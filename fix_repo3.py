...
repo_xml += '<addon id="repository.mcfenlight" name="McFenlight Repository" version="1.0.3" provider-name="McMoobud">\n'
repo_xml += '    <requires>\n'
repo_xml += '        <import addon="xbmc.addon" version="21.0.0"/>\n'
repo_xml += '    </requires>\n'
repo_xml += '    <extension point="xbmc.addon.repository" name="McFenlight Repository">\n'
repo_xml += '        <dir minversion="21.0.0">\n'
...
zp = os.path.join(repo_dir, 'repository.mcfenlight-1.0.3.zip')
...
idx = '<html><body>\n'
idx += '<a href="repository.mcfenlight-1.0.3.zip">repository.mcfenlight-1.0.3.zip</a>\n'
idx += '<a href="addon.xml">addon.xml</a>\n'
idx += '</body></html>\n'
open(os.path.join(repo_dir, 'index.html'), 'w').write(idx)
print('Done - v1.0.3 with dir minversion=21.0.0')
